...
# Lệnh chạy
# python ./Create_VN07/create_vn07_dataset.py
...
def main():
    ...
    train_df.to_csv('data/VN07/train.txt', sep='\t', index=False, header=False)
    dev_df.to_csv('data/VN07/dev.txt', sep='\t', index=False, header=False)
    test_df.to_csv('data/VN07/test.txt', sep='\t', index=False, header=False)
